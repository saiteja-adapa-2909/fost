...
import mainFruits from "../images/mainfruits.jpg";

const Hero: React.FC = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-[#FF9EAA] to-[#FFD66B]">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                ...
                <span className="block text-[#98FF98]">Fruit Juices</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          // src="https://images.unsplash.com/photo-1546173159-315724eb42c9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
          src={mainFruits}
